...
class Nave:
    ...
    def golpeando(self, asteroide):
        if (self.x - self.tamaño < asteroide.x + asteroide.tamaño and \
            self.x + self.tamaño > asteroide.x - asteroide.tamaño and \
            self.y - self.tamaño < asteroide.y + asteroide.tamaño and \
            self.y + self.tamaño > asteroide.y - asteroide.tamaño):
            return True
        return False