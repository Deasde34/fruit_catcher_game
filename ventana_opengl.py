...
def actualizar():
    global tiempo_anterior, window, nave, manzanas
    ...
    for manzana in manzanas:
            if manzana.vivo and nave.golpeando(manzana):
                print ("colision !") 
...
def inicializar():
    ...
    for i in range(5):
        manzana = Manzana()
        manzana.angulo = random.randint(0, 360)
        manzana.tamaño = (random.random() * 0.10) + 0.05
